...
function doPost(e) {
  ...
  return ContentService.createTextOutput(row).setMimeType(
...
function testPost() {
  ...
  var data = {
    callback:
      "https://script.google.com/macros/s/AKfycbxAnr781LarJsrDJgFzq1zr1rq2OECY4gzRA7Z8iFP_ShFQbnQB/exec",
    ...
    id:
      "#niko@passentry.com#passentry.demo#810ce8e0-1f11-4e29-a35e-cdf326fb90c2"
  };
